//本文件填写2-移植修改资质选项至mod人物对话中选项46143176-0d1b-4921-bc31-a37428e8f256在事件执行周期内的相关阶段函数
...
public class EventOption_461431760d1b4921bc31a37428e8f256 : Event_f387e43facac4e88ae3292ccb64adfa7
{
#endif
    ...
    private bool OnVisibleCheck()
    {
        ...
        if (flag == true)
        {
            ...
            {
                //EventHelper.Log("此对话不是与修改资质mod人物的对话，不显示修改资质选项。");
                return false;
            }
        }
        else
